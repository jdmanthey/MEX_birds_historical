...
grep "^#" Atl_structure_NC_080430.1.recode.vcf > Atl_structure.vcf
...
##########################################
##########################################
### do again for mapdamage datasets
##########################################
##########################################
...
# cat the vcf files for each species
grep "^#" Atl_NC_080430.1.subset.vcf > Atl_transversions.vcf
...
##########################################
##########################################
### do again for transversion dataset 3
##########################################
##########################################


cd ${workdir}/07c_transversions
