options(scipen=999)
project_directory <- "/lustre/scratch/jmanthey/09_mexico/06_stats_cat"
directory_name <- "38_stats_cat"
cluster <- "nocona"
max_number_jobs <- 60
...
vcf_header <- paste0(project_directory, "/NC_046260.1.recode.vcf.gz")
...
ref_index <- read.table("GCF_009819885.2_bCatUst1.pri.v2_genomic.fna.fai", stringsAsFactors=F)
