...
if [[ $prop_array == "1" ]]; then 
	...
	cp ${workdir}/01_bam_files/${basename_array}_prefinal.bam ${workdir}/01b_bam_files/${basename_array}_final.bam

	cp ${workdir}/01_bam_files/${basename_array}_prefinal.bam.bai ${workdir}/01b_bam_files/${basename_array}_final.bam.bai

else
	
	java -jar /home/jmanthey/picard.jar DownsampleSam \
	I=${workdir}/01_bam_files/${basename_array}_prefinal.bam \
