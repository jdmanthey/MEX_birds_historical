options(scipen=999)
project_directory <- "/lustre/scratch/jmanthey/09_mexico/06_stats_atl"
directory_name <- "36_stats_atl"
cluster <- "nocona"
max_number_jobs <- 60
...
vcf_header <- paste0(project_directory, "/NW_026652215.1.recode.vcf.gz")
...
ref_index <- read.table("GCF_028018845.1_bMelGeo1.pri_genomic.fna.fai", stringsAsFactors=F)
